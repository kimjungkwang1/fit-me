package site.chachacha.fitme.advice;
...
import site.chachacha.fitme.advice.dto.ErrorResponse;
...
public class ControllerAdvice {
    ...
    public ResponseEntity<ErrorResponse> unexpectedRException(RuntimeException e) {
        log.error("{} error message >> {} ", e.getClass().getSimpleName(), e.getMessage(), e);
